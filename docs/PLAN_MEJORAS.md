...
| **Servidor sin roles**                                                                                                 | Bus entre réplicas ✅ (H1 #6); sigue un solo workspace y sin permisos por diagrama.               | No sirve a equipos con permisos (H1 #7).                                                    |

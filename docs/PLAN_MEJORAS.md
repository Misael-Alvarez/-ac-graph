...
| --------------------------- | ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **H1 · Consolidar**         | **7 de 8 cerrados** | ✅ #1 consolidación CSS (fase 1, exacta) · ✅ #2 componentes (`PanelHead`, inspector partido; falta `Row/Tile/Field`) · ✅ #3 E2E estables + auditoría en CI · ✅ #4 regresión visual (24 estados) · ✅ #5 observabilidad (logs JSON, `/api/metrics`, OTel opcional) · ⏳ #6 bus multi-réplica · ⏳ #7 roles · ✅ #8 páginas de error/404 (esqueletos pendientes) |

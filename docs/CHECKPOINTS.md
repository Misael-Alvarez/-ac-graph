...
> **Checkpoint vigente (2026-09-10):** H1 cerrado del todo. **H2: #10 presentacion (`91435f5`) y #12 notas, texto y regiones** (entregado hoy, pendiente de commit y push). Para retomar: `docs/CONTEXTO.md`. Siguiente: H2 #20 plantillas propias, #14 iconos en servidor, #9 comentarios, #11 conectores.
...
1. Confirmar H2 #12 (notas, texto y regiones) en un commit y `git push`; reconstruir la imagen Docker local.
2. Seguir H2: #20 plantillas propias (S), #14 iconos en servidor (M), #9 comentarios anclados (L), #11 conectores editables (L).

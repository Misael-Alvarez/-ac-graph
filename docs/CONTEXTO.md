...
- Pruebas: `src/**/*.test.ts` (1476 sin PostgreSQL; +76 con `TEST_DATABASE_URL`), `e2e/*.spec.ts` (175 funcionales + `visual.spec.ts` 24), líneas base en `e2e/__screenshots__/`; `audit:controls` 134, `audit:roles` 39.
